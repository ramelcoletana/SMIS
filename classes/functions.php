...
class sqlfunction extends DB_Connect{
    ...
    /*/========================/*/
    function doneAssessmentModeFP($enrollmentNo,$studentNum,$schYear,$gy,$status, $age){
        ...
        $sqlUpdateStudRec = "UPDATE tblstudentrecord SET fldAge = $age, fldStudent_Status='$status' WHERE fldStudent_No='$studentNum'";
    ...
    function doneMSAssessment($transactionNo,$enrollmentNo,$studentNo,$schoolYear,$grade_Year,$age){
        ...
        $sql4 = "UPDATE tblstudentrecord SET fldAge = $age, fldStudent_Status='enrolled' WHERE fldStudent_No='$studentNo'";
        mysql_query($sql4,$this->openCon());
